...
public class Actor extends TableImpl<ActorRecord> {
    ...
    private static final long serialVersionUID = -927967347;
     ...
     */
    public final TableField<ActorRecord, Integer> ACTORID = createField("ACTORID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_39D31D9C_4B4E_4851_A102_6672E6FF9EDE)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
